			...
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						...
						<th style="min-width: 60px;"><?php echo L('AGE');?></th>
						<th style="min-width: 60px;"><?php echo L('SEX');?></th>
						<th style="min-width: 60px;"><?php echo L('DEGREE');?></th>
						<th style="min-width: 60px;"><?php echo L('JOB');?></th>
